...
public class SparkUtil {
    // Stores whether any error has been detected by other utility mehtods. 
    public static boolean sparkStickyFault = false;

    // Process a value from a Spark only if the value is valid.
    ...
    // Processs a value from a Spark only if the value is valid 
    ...
    // Attemps to run the comman until no error is produced 
