...
public class DeepClimbConstants {
    ...
    public static final double DEEPCLIMB_D = 0.0;
    public static final double DEEPCLIMB_FF = 0.0;

    public static final int CURRENT_LIMIT = 40;

    public static final double HOME_SETPOINT = 0; // TODO: find
    public static final double CLIMB_SETPOINT = 0; // TODO: find
