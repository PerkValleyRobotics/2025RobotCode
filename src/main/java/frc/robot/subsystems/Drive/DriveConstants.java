...
public class DriveConstants {
  ...
  public static final double DRIVE_ENCODER_POSITION_FACTOR = 2 * Math.PI / DRIVE_MOTOR_REDUCTION; // Rotor Rotations ->
                                                                                                  // Wheel Radians
  public static final double DRIVE_ENCODER_VELOCITY_FACTOR = (2 * Math.PI) / 60.0 / DRIVE_MOTOR_REDUCTION; // Rotor RPM
                                                                                                           // -> Wheel
                                                                                                           // Rad/Sec
  ...
  public static final double TURN_ENCODER_POSITION_FACTOR = 2 * Math.PI / TURN_MOTOR_REDUCTION; // Rotor Rotation ->
                                                                                                // Wheel Radians
  public static final double TURN_ENCODER_VELOCITY_FACTOR = 2 * Math.PI / 60.0 / TURN_MOTOR_REDUCTION; // totor RPM - >
                                                                                                       // Wheel Rad/Sec
