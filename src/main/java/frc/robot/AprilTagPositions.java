...
public final class AprilTagPositions {
        ...
        public static final HashMap<Integer, Pose2d> WELDED_RED_HP_STATION_APRIL_TAG_POSITIONS = new HashMap<>();
        static {
                WELDED_RED_HP_STATION_APRIL_TAG_POSITIONS.put(1, WELDED_APRIL_TAG_POSITIONS.get(1));
                WELDED_RED_HP_STATION_APRIL_TAG_POSITIONS.put(2, WELDED_APRIL_TAG_POSITIONS.get(2));
        }
        public static final HashMap<Integer, Pose2d> WELDED_BLUE_HP_STATION_APRIL_TAG_POSITIONS = new HashMap<>();
        static {
                WELDED_BLUE_HP_STATION_APRIL_TAG_POSITIONS.put(12, WELDED_APRIL_TAG_POSITIONS.get(12));
                WELDED_BLUE_HP_STATION_APRIL_TAG_POSITIONS.put(13, WELDED_APRIL_TAG_POSITIONS.get(13));
        }
}
