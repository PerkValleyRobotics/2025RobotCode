...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystickMoveTrigger.or(driverController.pov(180)).whileTrue(new InstantCommand(() -> driveToNearestReefSideCommandLeft.end(false))
        .alongWith(new InstantCommand(() -> driveToNearestReefSideCommandRight.end(false)))
        .alongWith(new InstantCommand(() -> driveToNearestReefSideCommandCenter.end(false))));
